        ...
        <section class="item_panel">
            ...
            <div class="item_details">
                <aside class="img_section">
                    <img class="main_img" src="/assets/img/products/0/products.jpg" alt="T-shirt"/>        
                    <section>
                        <img class="sub_img" src="/assets/img/products/1/T-shirt.jpg" alt="T-shirt"/>
                        <img class="sub_img default_main_img" src="/assets/img/products/0/products.jpg" alt="T-shirt"/>
                        <img class="sub_img" src="/assets/img/products/2/Shorts.jpg" alt="T-shirt"/>
                        <img class="sub_img" src="/assets/img/products/3/Shoes.jpg" alt="T-shirt"/>
                    </section>
                </aside>
